...
from .views import SendEmailOTPView,VerifyEmailOTPView,VerifyPasswordResetAPIView,PasswordRestRequestAPIView,UserSearchAPIView
...
urlpatterns = [
    ...
    path(
        ...
        PasswordRestRequestAPIView.as_view(),
